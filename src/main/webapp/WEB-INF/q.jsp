...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://www.hmlzs.cn/static/lzs/css/style.css"/>
    <style>
        .s_tool_select{
            font-size: 12px;
        }
    ...
    <div class="container">
        ...
        <div class="navbar">
            <div class="wrapper" id="navbar">
                <script type="text/javascript" src="http://www.hmlzs.cn/base/nav.html"></script>
            </div>
        </div>
        <div class="content">
            <div class="notice">
                ...
                <p>
                    <strong>活动通知</strong>
                    <script type="text/javascript" src="http://www.hmlzs.cn/base/notice.html"></script>
                </p>
            ...
            <div class="rightside">
                <script type="text/javascript" src="http://www.hmlzs.cn/base/fawu.html"></script>
                <script type="text/javascript" src="http://www.hmlzs.cn/base/futian.html"></script>
            </div>
        </div>
        <!-- /content -->
...
<!-- /main -->
<script type="text/javascript" src=http://www.hmlzs.cn/static/lzs/js/header.js></script>

<script type="text/javascript" src=http://www.hmlzs.cn/static/lzs/js/jquery/jquery-1.8.3.min.js></script>

<script type="text/javascript" src=http://www.hmlzs.cn/static/lzs/js/jquery/plugin/jquery.cycle.all.js></script>

<script type="text/javascript" src=http://www.hmlzs.cn/static/lzs/js/audiojs/audio.min.js></script>
